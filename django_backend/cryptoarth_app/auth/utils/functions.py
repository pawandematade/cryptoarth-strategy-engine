from ..models import SymbolMaster, User, latencycheck, userStratergyPortfolio, tradeDetails, OrderDetails, customer_failorder
import requests
import json
...
from apps.auth.serializers import UserStrategyPortfolioSerializer,PositionSerializer
...
from apps.auth.models import adminPosition,Position,SymbolMaster
