...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    is_orderlatency = models.BooleanField(default=False)
    is_userstrategy = models.BooleanField(default=False)
    is_learning = models.BooleanField(default=False)
    is_business_report = models.BooleanField(default=False)
    is_credit_ai = models.BooleanField(default=False)
...
class copysignal(models.Model):
    ...
    is_trailing = models.BooleanField(default=False)
