...
def copilot_confirm(
    ...
    try:
        ...
        logger.info(f"Copilot confirm â€“ credit deducted: user_id={user.id}, credits={required_credits}")
        ...
        try:
            logger.info("ðŸ¤– Calling OpenAI compiler with confirmed strategy")
            ...
            logger.info(f"âœ… Strategy generated successfully: {strategy.get('strategy_type')}")
